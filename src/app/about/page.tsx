      ...
      <section className="mb-12 border-2 border-black bg-white p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/3">
            <div className="border-2 border-black p-2 bg-yellow-300 shadow-[4px_4px_0px_rgba(0,0,0,1)] rotate-2">
              <Image
                src={Reset}
                width={500}
                height={500}
          ...
          <div className="w-full md:w-2/3">
            <p className="text-lg mb-4">
              Hey there! I'm Reset, a full-stack developer, tech enthusiast and
              shameless opinionator.
            </p>
            <p className="mb-4">
              I started <span className="font-bold">ctrl+alt+reset</span> as a
              place to document my developer journey, share insights about
              software development, and share opinions about anything that
              interests me.
            </p>
            <p>
              When I'm not coding, you can find me gaming with friends, watching
              a good movie, or diving into classical novels.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12 border-2 border-black bg-white p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)]">
        ...
        <div className="space-y-4">
          <p>
            ...
            about how websites work. That curiosity quickly turned into a
            passion as I discovered how coding allows me to bring creative ideas
            to life and solve real-world problems.
          </p>
          <p>
            I've worked on projects ranging from interactive web applications to
            advanced backend systems. I'm always eager to learn new technologies
            and improve my skills. My goal is to create software that not only
            works well but also provides a great user experience.
          </p>
          <p>
            This blog is built with Next.js and styled with Tailwind CSS using a
            neo-brutalist design approach. It's a playground for me to
            experiment with new techniques while sharing what I learn along the
            way.
          </p>
        </div>
      </section>
