...
export default function About() {
    return (
        <main className="container mx-auto py-10 px-4 max-w-4xl">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="w-full md:w-2/3">
                        ...
                        <p className="mb-4">
                            ...
                            developer journey, share insights software development, and share opinions about anything
                            that interests me.
                        </p>
                        <p>
            ...
            {/* Contact CTA */}
            <section className="border-2 border-black bg-pink-100 p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)]">
