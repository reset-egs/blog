...
export default function Home() {
    ...
    return (
        <main className="container mx-auto py-6 sm:py-10 px-4">
            {/* Hero Section */}
            <section
                className="mb-10 sm:mb-16 border-2 border-black bg-white p-5 sm:p-8 shadow-[5px_5px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-lg sm:text-xl mb-4 sm:mb-6">
                    Thoughts and opinions on software development, technology, politics, and everything in between.
                </p>
                <Link
                    href="/about"
            ...
            {featuredPost && (
                <section className="mb-10 sm:mb-16">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 inline-block border-b-4 border-pink-300 pb-1">Featured
                        Post</h2>
                    <div className="grid grid-cols-1 gap-6">
                        <div
                            className="border-2 border-black bg-white p-4 sm:p-6 shadow-[4px_4px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_rgba(0,0,0,1)]">
                            <div
                                className="relative w-full h-48 sm:h-64 md:h-80 mb-4 border-2 border-black overflow-hidden">
                                <Image
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold mb-2">{featuredPost.title}</h3>
                            <p className="text-gray-700 mb-4 line-clamp-2 sm:line-clamp-none">{featuredPost.description}</p>
                            <Link
            ...
            <section className="mb-10 sm:mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 inline-block border-b-4 border-yellow-300 pb-1">Latest
                    Posts</h2>
