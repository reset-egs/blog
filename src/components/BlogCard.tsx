...
export default function BlogCard({
  ...
  return (
    <div className="border-2 border-black bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-shadow overflow-hidden flex flex-col h-full">
